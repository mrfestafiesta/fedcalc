...
export function handleOrientation(e) {
    ...
    document.getElementById('compass-status').innerText = `Heading: ${state.deviceHeading.toFixed(0)}°`;
    updateARPositions();
}
...
export function toggleCompassUI(turningOn) {
    ...
    if (!turningOn) document.getElementById('compass-status').innerText = 'Compass: Off';
}
